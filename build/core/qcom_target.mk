...
$(call set-device-specific-path,AUDIO,audio,hardware/qcom-caf/sm8150/audio)
$(call set-device-specific-path,DISPLAY,display,hardware/qcom-caf/sm8150/display)
$(call set-device-specific-path,MEDIA,media,hardware/qcom-caf/sm8150/media)
